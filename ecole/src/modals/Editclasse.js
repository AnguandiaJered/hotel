...
export const Editclasse = () => {
  ...
  const {designation,montant,devise,idclass} = classroom;
  ...
  const onSubmit = async e =>{
      e.preventDefault();
      await axios.put(`http://localhost:8080/chambre/update/${id}`,classroom);
      history.push("/");
  };
