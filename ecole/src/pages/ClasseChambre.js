...
const ClasseChambre = () =>{
    ...
    useEffect( async () => {
        await axios.get('http://localhost:8080/classroom/showallclassroom').then((res) =>{
    ...
    const deleteClasse = async (id) =>{
      await axios.delete(`http://localhost:8080/classroom/delete/${id}`)
        .then((res)=>{
            setClassRoom(res.data);
        })        
    };
                            ...
                            {classroom &&
                                ...
                                <StyledTableRow key={index}>
                                    ...
                                    <StyledTableCell align="center">
                                        <Editclasse/>
                                        <Link onClick={() => deleteClasse(item.id)} to="#" className="btn btn-danger bd ml-2"><i className="fa fa-trash"></i></Link>
                                    </StyledTableCell>                                                                                                                                                                                                                                     
                                </StyledTableRow>
                            ))}
                            </TableBody>
